...
import karlh.ecidemoapp.utils.AddressUtil;
import karlh.ecidemoapp.utils.CommonUtils;
import karlh.ecidemoapp.utils.ProgressDialogFragment;
...
public class OAuthLoginActivity extends MyActivity {
     ...
     */
    private void proceedToCodeActivity() {
        Intent intent = new Intent(OAuthLoginActivity.this, CodeActivity.class);
    ...
    private void goBackToLoginScreen() {
        Intent i = new Intent(OAuthLoginActivity.this, LoginActivity.class);
    ...
    private void loginPayPalFailed(String msg) {
        ...
        msg = (CommonUtils.isNullOrEmpty(msg) ? "Login Failed!" : "Login Failed : " + msg);
    ...
    private void setMerchantAndCheckIn(String accessToken, String refreshUrl) {
        // Save the refresh url for future use.
        ...
        PayPalHereSDK.setCredentials(credentials, new DefaultResponseHandler<Merchant,
            ...
            public void onSuccess(Merchant merchant) {
                ...
                // Check-in the merchant in order to enable checked-in payments.
                // NOTE: If the merchant is already checked in with the PayPal backend,
                // the SDK would've saved that Location ID and use the same.
                checkinMerchant();
    ...
    private class LoginTask extends AsyncTask<String, Void, ArrayList<String>> {
        ...
        private synchronized void parseMerchantInfo(JSONObject merchantInfoJson) {
            ...
            try {
                //String businessName = merchantInfoJson.getString("businessName");
                String businessName = "Karl's ECI Shop";
                String countryCode = merchantInfoJson.getString("country");
                //String addressLine1 = merchantInfoJson.getString("line1");
                String addressLine1 = "2211 North 1st St";
